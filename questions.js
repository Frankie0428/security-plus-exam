...
const questionBank = [
  ...
  },
  {
    ...
    options: ["All traffic is blocked (availability issue)", "Traffic bypasses the WAF (reduced security)", "WAF continues filtering with cached rules", "Traffic automatically redirects to a backup WAF"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Centralized logging of administrative access", "Load balancing for admin connections", "High availability for production systems", "Encryption of administrative traffic"],
    correct: 0,
